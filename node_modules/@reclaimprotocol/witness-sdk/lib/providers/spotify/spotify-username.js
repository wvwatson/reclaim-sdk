...
const spotifyUserName = {
    ...
    areValidParams(params) {
        return typeof (params === null || params === void 0 ? void 0 : params.userName) === 'string';
    },
    createRequest({ token }) {
    ...
    assertValidProviderReceipt(receipt, { userName }) {
        ...
        const resUserName = (_a = json.profile) === null || _a === void 0 ? void 0 : _a.username;
        if (resUserName !== userName) {
            throw new Error('Username does not match');
        }
    },
};
exports.default = spotifyUserName;
