...
const UidaiAadhaarPhone = {
    ...
    assertValidProviderReceipt(receipt, { mobile }) {
        ...
        if (json.responseData.mobile !== mobile) {
            throw new Error(`Invalid Mobile Number: Mobile Number doesn't match fetched mobile number ${json.responseData.mobile}`);
        }
    },
};
exports.default = UidaiAadhaarPhone;
